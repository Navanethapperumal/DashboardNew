...
@Component({
  selector: 'app-widget-time-series-zoomable',
  templateUrl: './time-series-zoomable.component.html',
  styleUrls: ['./time-series-zoomable.component.scss']
})
export class TimeSeriesZoomableComponent {
   ...
   chartOptions = {   
      ...
      title: {
        text: 'Server-1 utilization tine from 2006 through 2008'
      },
      subtitle: {
